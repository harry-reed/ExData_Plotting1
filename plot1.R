...
# creates a PNG image (480 X 480, titled 'plot1.png'),   #
# a histogram plot of a household's ...                  #
...
# first class assignment, part one (Plot 1).             #
##########################################################
...
##########################################################
# Begin code section specific to plot assignment 1.      #
#                                                        #
# Plot is a red-filled histogram of ...                  #
#                                                        #
#             Frequency           (Y-axis)               #
#             Global_active_power (X-axis)               #
#                                                        #
# NOTE: Plot created is a PNG image with 480X480 pixel   #
#       resolution, named 'plot1.png'.                   #
##########################################################

if (file.exists("plot1.png")) {          ## Remove old plot result.
    file.remove("plot1.png")
}

png("plot1.png", width=480, height=480)  ## Plot display is PNG.

    # Generate the histogram plot.
    hist(x = theData$Global_active_power,
        col="red",                       ## Bar fill is red.
        mar=c(3,3,3,1),                  ## Plot margin.
